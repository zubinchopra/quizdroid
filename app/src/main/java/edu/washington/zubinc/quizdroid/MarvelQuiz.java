...
public class MarvelQuiz extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.submit.setOnClickListener(new MyListener(this, options, this.o3));
    ...
    public class MyListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            String[] packet = new String[]{selected, "Captain America", "Next", "" + n};
