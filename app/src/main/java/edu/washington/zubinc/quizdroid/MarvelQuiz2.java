...
public class MarvelQuiz2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.submit.setOnClickListener(new MyListener(this, options, this.o4, this.s));
    ...
    public class MyBackButton implements View.OnClickListener{
        ...
        @Override
        public void onClick(View v) {
            intent = new Intent(this.activity, MarvelQuiz2.class);
    ...
    public class MyListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            String[] packet = new String[]{selected, "Mark XLII", "Finish", "" + n};
