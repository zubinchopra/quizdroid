...
public class PhysicsQuiz2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.submit.setOnClickListener(new MyListener(this, options, this.o1, this.s));
    ...
    public class MyListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            String[] packet = new String[]{selected, "N", "Finish", "" + n};
